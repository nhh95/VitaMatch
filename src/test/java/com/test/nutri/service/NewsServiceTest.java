 ...
 *//**
	 ...
	 */
/*
 * @SpringBootTest public class NewsServiceTest {
 * 
 *//**
 ...
 *//**
	 ...
	 * 여부를 비교하는 용도로 사용됩니다.
	 *//*
		 * @Test public void checkTime() { int rotateCount = 5; long beforeAvg = 0; long
		 * afterAvg = 0;
		 * 
		 * long newsCount = repository.count();
		 * 
		 * if(newsCount == 0) { service.insertAllNews(); }
		 * 
		 * for (int i = 0; i < rotateCount; i++) { long startTime = System.nanoTime();
		 ...
		 * (beforeAvg / 1_000_000.0), (int) (beforeAvg / 1_000_000_000.0));
		 * System.out.printf("개선 메서드 평균 시간: %dns, %dms, %dsec\n", afterAvg, (int)
		 * (afterAvg / 1_000_000.0), (int) (afterAvg / 1_000_000_000.0)); // 이전 메서드 평균
		 * 시간: 1031453593ns, 1031ms, 1sec // 개선 메서드 평균 시간: 103157846ns, 103ms, 0sec
		 * 
